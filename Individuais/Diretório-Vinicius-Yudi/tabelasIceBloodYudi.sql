...
setorArduino varchar (20),
tipocamera varchar (20),
dtInstalacao date,
fk_Filial int,
...
CONSTRAINT fk_sensor_arduino FOREIGN KEY (fk_arduino) REFERENCES arduino(idArduino)
);
...
CONSTRAINT fk_registro_sensor FOREIGN KEY (fk_sensor) REFERENCES sensor(idSensor)
);
